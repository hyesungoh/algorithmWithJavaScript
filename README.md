...
- [프로그래머스 자연수 뒤집어 배열로 만들기](../master/Problem/프로그래머스_자연수_뒤집어_배열로_만들기.js)

  정수 n이 주어진 후, 해당 정수를 정수로 이루어진 배열로 만든 후 뒤집은 배열을 반환하는 문제. `Array.from`을 이용하여 풀었다.

#### 21.9.6

- [프로그래머스 2016년](../master/Problem/프로그래머스_2016년.js)

  월, 일이 주어졌을 때 2016년의 해당 날짜는 무슨 요일인지 반환하는 문제. 요일과 각 월별 일수를 이용하여 진행된 일수를 이용해 풀었다.

#### 21.9.7

- [프로그래머스 문자열 다루기 기본](../master/Problem/프로그래머스_문자열_다루기_기본.js)
...
- [프로그래머스 약수의 개수와 덧셈](../master/Problem/프로그래머스_약수의_개수와_덧셈.js)
...
- [프로그래머스 가장 큰 수](../master/Problem/프로그래머스_가장_큰_수.js)

  문자열로 변환 후, 더한 값을 기준으로 정렬하여 풀었다.

- [프로그래머스 기능개발](../master/Problem/프로그래머스_기능개발.js)

  배열의 첫 번째 기능이 완성되는 것을 기준으로 날짜 값을 증감 후, 조건이 달성될 시 shift를 이용하여 계속 첫 번째 값과 증감된 날짜를 기준으로 풀었다.

#### 21.11.14

- [프로그래머스 타겟 넘버](../master/Problem/프로그래머스_타겟_넘버.js)
...
- [프로그래머스 두 개 뽑아서 더하기](../master/Problem/프로그래머스_두_개_뽑아서_더하기.js)

  정수로 이루어진 배열에서 두 개를 뽑아서 더했을 때 나올 수 있는 수를 정렬하여 반환하는 문제. 중복 제거를 위해 Set 자료형을 이용하여 풀었다.

#### 22.1.15

- [프로그래머스 위장](../master/Problem/프로그래머스_위장.js)
...
- [프로그래머스 구명보트](../master/Problem/프로그래머스_구명보트.js)
...
- [프로그래머스 네트워크](../master/Problem/프로그래머스_네트워크.js)
...
- [프로그래머스 완주하지 못한 선수](../master/Problem/프로그래머스_완주하지_못한_선수.js)
